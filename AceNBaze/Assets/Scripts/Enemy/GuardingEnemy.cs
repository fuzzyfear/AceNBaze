...
public class GuardingEnemy : StateMachineBehaviour
{
    private NavMeshAgent navMeshAgent;
    private string guardSpotName;
    private GameObject guardPost;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        //{
        //    navMeshAgent.destination = guardPost.transform.position;
        //}
    }
